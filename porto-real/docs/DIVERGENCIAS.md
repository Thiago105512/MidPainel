# Divergências e decisões de compatibilização

Duas bases de dados foram fornecidas e **não coincidem**. A *Lista Consolidada
(pós-R32)* declara substituir o levantamento anterior; o *Guia Explicativo R32*
estabelece a regra de precedência ("quando uma geometria H de revisão anterior
divergir, a R32 prevalece"), mas é ele próprio a revisão anterior.

**Regra adotada: a Lista Consolidada prevalece.** Onde ela é omissa, adota-se
a R32 e marca-se o item como (H).

## 1. Divergências entre as duas bases

| Item | Guia R32 | Lista Consolidada | Adotado |
|---|---|---|---|
| Início longitudinal | Y = 7.000 mm | Y = 7.200 mm | 7.200 |
| Corpo do térreo | 11.000 × 14.000 mm | Y 7.200 a 26.400 (19.200 de extensão) | Lista |
| Garagem | 5.300 × 5.300 = 28,09 m² | 6.000 × 6.000 = 36,00 m² | Lista |
| Hall térreo | 2.100 × 2.900 = 6,09 m² | 1.800 × 3.000 = 5,40 m² | 1.800 × 3.600 (ver 2.3) |
| Banheiro térreo | 2.100 × 2.300 = 4,83 m² | 1.800 × 2.400 = 4,32 m² | Lista |
| Quarto reversível | 3.100 × 5.300 = 16,43 m² | 18,00 m² (3.000×4.200 + faixa) | Lista |
| Estar/jantar | 5.500 × 4.400 = 24,20 m² | 4.200 × 6.000 = 25,20 m² | Lista |
| Core/escada | 1.900 × 4.400 = 8,36 m² | 2.400 × 6.000 = 14,40 m² | Lista |
| Cozinha | 3.100 × 4.400 = 13,64 m² | 3.000 × 6.000 = 18,00 m² | Lista |
| Lavanderia | 1.800 × 1.800 = 3,24 m² | 3.000 × 3.000 + DML 3.000 × 1.200 | Lista |
| Gourmet | 10.700 × 3.800 = 37,42 m² | 4.200 × 7.200 = 30,24 m² | Lista |
| Suítes 2 e 3 | 5.300 × 5.700 = 30,21 m² | 5.400 × 4.800 = 25,92 m² | Lista |
| Suíte master | 7.450 × 6.300 = 46,94 m² | 6.000 × 4.800 = 28,80 m² | Lista |
| Varanda master | 7.700 × 2.100 = 16,17 m² | 6.000 × 1.800 = 10,80 m² | Lista |
| Terraço técnico | 3.050 × 6.300 = 19,21 m² | ausente | **não adotado** |
| Piscina | 5.500 × 3.200 mm | 4.800 × 2.400 (lâmina 11,52 m²) | Lista |
| Portas internas | P02 800×2100 **e** P03 900×2100 | família unificada 900×2100 | Lista |
| Estrutura | metálica convencional + sapatas | LSF + perfis + **radier** | Lista |
| Faixa técnica | 3.200 mm (base) | mínimo 3.000 mm | 3.200 mm |

## 2. Inconsistências internas da própria Lista Consolidada

### 2.1 Suíte master não fecha
Módulo declarado: 6.000 × 4.800 = **28,80 m²**.
Soma das subdivisões declaradas: dormitório 3.900×4.200 (16,38) + closet
2.400×2.400 (5,76) + banheiro 2.400×3.000 (7,20) + office 1.800×2.100 (3,78)
= **33,12 m²** — excede o módulo em 4,32 m².

*Resolução adotada:* banheiro 2.400×3.000, closet 2.400×1.800, dormitório
3.600×4.800; o office de 1.800×2.100 é incorporado como nicho do dormitório,
não como compartimento. Fecha em 28,80 m².

### 2.2 Circulação do pavimento superior é insuficiente
O briefing fixa 84,96 m² fechados = 25,92 + 25,92 + 28,80 + **4,32** de hall.
Um hall de 4,32 m² não atinge simultaneamente três suítes e a chegada da
escada sem corredor — e corredores longos são proibidos pelo próprio briefing.

*Resolução adotada:* hall compacto de 2.400 × 2.400 = 5,76 m², central, com as
três portas e a escada em contato direto. Área superior passa a **86,40 m²**
(delta de +1,44 m²), e a circulação fica em 6,7 % da área interna — dentro da
meta de 8 %.

### 2.3 Térreo fecha 173,16 e não 174,24
A soma dos ambientes listados dá 173,16 m²; o alvo declarado é 174,24 m².
O delta de 1,08 m² foi alocado ao hall, que passa de 1.800×3.000 para
1.800×3.600 (6,48 m²). O térreo fecha então **exatamente** em 174,24 m².

### 2.4 Família adicional de esquadria (PV02)
Na organização adotada, o estar/jantar precisa de face externa para ventilação
cruzada e saída ao pátio, mas o vão social PV01 (3.600 mm) não cabe no trecho
de parede externa disponível (3.000 mm). Criada a família **PV02 = 2.400 × 2.400**.
Isso contraria a diretriz de padronização — registre-se a exceção ou amplie o
trecho externo do estar.

### 2.5 Platibanda
O briefing fixa topo de platibanda em +6,150 m, válido para o volume de dois
pavimentos. Os blocos de um pavimento (garagem, gourmet, serviços) exigem cota
própria: adotado **+3,150 m** (2,600 de pé-direito + 0,150 de laje + 0,400 de
platibanda).

### 2.6 Diâmetro do chuveiro
Já sinalizado pelo próprio briefing: "chuveiro DN50" aparece tanto em água fria
quanto em esgoto. Mantido como pendência para o hidrossanitarista.

## 3. Decisões de projeto tomadas na organização da planta

O briefing dá o programa e as dimensões, não o arranjo. Adjacências adotadas:

1. **Cozinha na divisa oeste, lavanderia imediatamente ao norte** — o ramal
   hidrossanitário de cozinha, lavanderia e DML fica em uma única prumada.
2. **Estar/jantar entre cozinha e core**, com passagem direta ao gourmet, que
   abre para o deck e a piscina — atende "área social diretamente conectada à
   piscina" sem edícula.
3. **Pátio de serviço (3.000 × 7.200) entre a faixa de serviço e o gourmet** —
   dá acesso externo independente a lavanderia, oficina e DML, sem que serviço
   atravesse a área social.
4. **Garagem na testada, junto à divisa esquerda**, liberando a lateral direita
   inteira como faixa técnica contínua da frente ao fundo.
5. **Volume superior girado sobre o core**, com a master em balanço sobre o deck
   lateral — sombreia o deck e reduz insolação oeste no térreo. Exige a
   estrutura metálica específica que o briefing já prevê.
6. **Piscina no jardim posterior** (Y 27.600 a 30.000), a 1.200 mm do gourmet,
   preservando 10,00 m livres até o fundo.

## 4. O que continua não liberado

Reproduz as pendências do briefing, todas mantidas:
