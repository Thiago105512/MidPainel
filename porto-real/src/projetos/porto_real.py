...
REVISOES = [
    ...
    ("R76", "VISUALIZADOR PARA CELULAR. Indicadores em faixa rolavel, indice "
     "num <select> que espelha os botoes (pranchas, vistas e cenas), barra "
    ...
    ("R81", "PADROES DA CASA, NORMAS E HIPOTESES. As 188 constantes dos 15 modulos "
     "de instalacoes, piscina, canteiro, luz, marcenaria e acabamento ganham "
     "classe e dono em PADROES_DA_CASA: 85 padroes decididos pela casa (com o "
    ...
    ("R84", "DECK TODO EM WPC, decisao do proprietario. A faixa seca da piscina e "
     "o deck norte descoberto saem do porcelanato R11 e vao para o WPC "
     "coextrudado claro; o patio da churrasqueira fica em porcelanato. A conta "
     "de temperatura de R59 entra no modelo (externo.temperatura_superficie) "
     "com o albedo do WPC como hipotese do fabricante, e a auditoria passa a "
...
# =========================================================================
# R81 — PADROES DA CASA, NORMAS E HIPOTESES: toda constante tem dono
# =========================================================================
# O proprietario perguntou se "a logica de tudo e a padronizacao" e pediu que
# as decisoes fossem tomadas por ele. Estao aqui. Tres classes (nucleo/padroes):
#   padrao   — decisao da casa; o valor no 5o campo e o que o modulo passa a usar
#   norma    — limite de norma, tabela comercial ou fisica: ninguem aqui decide
#   hipotese — aguarda confirmacao de fora; o texto diz o DONO
# O que nao esta aqui e derivado: nunca se digita.
# (modulo, constante, classe, texto[, valor fixado[, unidade]])
PADROES_DA_CASA = [
    # ---- pontos eletricos: alturas e afastamentos
    ("nucleo.pontos", "Z_TUG", "padrao", "tomada baixa em toda a casa", 300, "mm"),
    ("nucleo.pontos", "Z_TUG_BANCADA", "padrao", "tomada de bancada: cozinha, gourmet e lavanderia", 1_100, "mm"),
    ("nucleo.pontos", "Z_TUG_LAVATORIO", "padrao", "tomada ao lado do lavatorio", 1_100, "mm"),
    ("nucleo.pontos", "Z_TV", "padrao", "tomada atras da TV, escondida pelo painel", 1_300, "mm"),
    ("nucleo.pontos", "Z_INTERRUPTOR", "padrao", "interruptor: a mesma altura em toda porta", 1_100, "mm"),
    ("nucleo.pontos", "Z_PARALELO", "padrao", "paralelo na cabeceira, ao alcance da mao deitada", 700, "mm"),
    ("nucleo.pontos", "Z_SPLIT", "padrao", "ponto do evaporador hi-wall", 2_200, "mm"),
    ("nucleo.pontos", "Z_EXAUSTOR", "padrao", "ponto da coifa e do exaustor", 2_200, "mm"),
    ("nucleo.pontos", "Z_FORNO", "padrao", "torre de forno: ponto atras do nicho", 1_100, "mm"),
    ("nucleo.pontos", "Z_TUE_PISO", "padrao", "TUE de piso (lava-loucas, bombas)", 300, "mm"),
    ("nucleo.pontos", "AFAST_VAO", "padrao", "do batente ao interruptor e da tomada ao vao", 300, "mm"),
    ("nucleo.pontos", "AFAST_CANTO", "padrao", "nenhum ponto a menos disto de um canto", 400, "mm"),
    ("nucleo.pontos", "AFAST_LAVATORIO", "padrao", "da cuba a tomada", 350, "mm"),
    ("nucleo.pontos", "ZONA1_BOX", "norma", "NBR 5410 zona 1: sem tomada a menos de 600 mm do box"),
    ("nucleo.pontos", "RECUO_FACE", "padrao", "convencao do modelo: o ponto fica 60 mm para dentro da face", 60, "mm"),
    ("nucleo.pontos", "TOL", "padrao", "tolerancia geometrica do modelo para casar ponto e parede", 80, "mm"),
    # ---- percurso: cotas, furos e fixadores
    ("nucleo.percurso", "Z_ELETRICA", "padrao", "eletroduto na parede na cota do furo de servico dos montantes", 1_450, "mm"),
    ("nucleo.percurso", "Z_AGUA", "padrao", "PEX na parede acima da guia e abaixo de qualquer caixa", 400, "mm"),
    ("nucleo.percurso", "Z_ENTERRADO", "padrao", "eletroduto externo enterrado", -400, "mm"),
    ("nucleo.percurso", "Z_ESGOTO_T", "padrao", "esgoto do terreo sob o radier", -150, "mm"),
    ("nucleo.percurso", "Z_ESGOTO_S_DESCE", "padrao", "esgoto do superior dentro do vigamento", -150, "mm"),
    ("nucleo.percurso", "D_ELETRODUTO", "padrao", "furo eletrico do montante", 25, "mm"),
    ("nucleo.percurso", "D_PEX", "padrao", "PEX de sub-ramal", 20, "mm"),
    ("nucleo.percurso", "FURO_HIDRAULICO", "padrao", "furo hidraulico do montante (PEX 20 com luva)", 32, "mm"),
    ("nucleo.percurso", "PASSO_MONTANTE_CLIP", "padrao", "clip de eletroduto nos montantes", 1_200, "mm"),
    ("nucleo.percurso", "PASSO_ABRAC_FORRO", "padrao", "abracadeira no forro e no entrepiso", 1_000, "mm"),
    ("nucleo.percurso", "PASSO_CLIP_PEX", "padrao", "clip de PEX: em todo montante", 600, "mm"),
    ("nucleo.percurso", "PASSO_ARAME_RADIER", "padrao", "arame do esgoto a tela do radier", 1_500, "mm"),
    ("nucleo.percurso", "PASSO_ABRAC_ESGOTO", "padrao", "abracadeira isofonica do esgoto no entrepiso", 1_000, "mm"),
    ("nucleo.percurso", "CAIXA_PASSAGEM_M", "norma", "NBR 5410 6.2.11: caixa de passagem a cada 15 m"),
    ("nucleo.percurso", "CAIXA_PASSAGEM_CURVAS", "norma", "NBR 5410 6.2.11: ou a cada 3 curvas"),
    ("nucleo.percurso", "TOL", "padrao", "tolerancia geometrica do grafo das paredes", 80, "mm"),
    # ---- piscina
    ("nucleo.piscina", "NIVEL_AGUA", "padrao", "lamina 100 mm abaixo da borda: o skimmer trabalha ai", 100, "mm"),
    ("nucleo.piscina", "DEGRAU_H_MAX", "norma", "NBR 10339: espelho maximo"),
    ("nucleo.piscina", "DEGRAU_L_MIN", "norma", "NBR 10339: piso minimo"),
    ("nucleo.piscina", "V_SUCCAO_MAX", "norma", "NBR 10339: velocidade maxima na succao"),
    ("nucleo.piscina", "V_RETORNO_MAX", "norma", "NBR 10339: velocidade maxima no retorno"),
    ("nucleo.piscina", "TAXA_FILTRACAO_MAX", "norma", "filtro de areia de alta taxa"),
    ("nucleo.piscina", "TAXA_RETROLAVAGEM", "hipotese", "dono: fabricante do filtro (manual)"),
    ("nucleo.piscina", "T_RETROLAVAGEM_MIN", "hipotese", "dono: fabricante do filtro (manual)"),
    ("nucleo.piscina", "RALO_DN75_M3H", "hipotese", "dono: hidraulico — capacidade do ralo a 2 % por Manning"),
    ("nucleo.piscina", "DRENOS_AFAST_MIN", "norma", "NBR 10339: antiaprisionamento"),
    ("nucleo.piscina", "SUCCAO_MAX_MM", "padrao", "succao maxima da casa de maquinas a piscina", 10_000, "mm"),
    ("nucleo.piscina", "CAIMENTO_DECK", "padrao", "deck cai 1 % para fora da agua", 0.01, ""),
    ("nucleo.piscina", "LASTRO", "padrao", "brita sob a laje de fundo", 100, "mm"),
    ("nucleo.piscina", "BORDA_ESP", "padrao", "peca de borda", 30, "mm"),
    ("nucleo.piscina", "BORDA_PECA", "padrao", "comprimento da peca de borda", 600, "mm"),
    ("nucleo.piscina", "LED_PROF", "padrao", "LED subaquatico abaixo da agua", 500, "mm"),
    ("nucleo.piscina", "LED_LM_W", "hipotese", "dono: fabricante do LED (datasheet)"),
    ("nucleo.piscina", "LED_W_M2", "hipotese", "dono: luminotecnico — faixa de potencia especifica"),
    ("nucleo.piscina", "LED_V", "norma", "NBR 5410 zona 0: SELV 12 V"),
    ("nucleo.piscina", "QUEDA_LED_MAX", "padrao", "queda admitida no cabo de 12 V", 5.0, "%"),
    ("nucleo.piscina", "REND_MOTOR", "hipotese", "dono: fabricante da bomba (placa)"),
    ("nucleo.piscina", "FP_MOTOR", "hipotese", "dono: fabricante da bomba (placa)"),
    ("nucleo.piscina", "H_FILTRO_SUJO", "hipotese", "dono: fabricante do filtro"),
    ("nucleo.piscina", "H_ACESSORIOS", "hipotese", "dono: instalador da piscina"),
    ("nucleo.piscina", "C_HW", "norma", "Hazen-Williams para PVC"),
    ("nucleo.piscina", "RHO_CU", "norma", "resistividade do cobre"),
    ("nucleo.piscina", "SECOES", "norma", "secoes comerciais de cabo"),
    ("nucleo.piscina", "DI", "norma", "catalogo: diametro interno do PVC soldavel"),
    # ---- canteiro
    ("nucleo.canteiro", "EQUIPE", "hipotese", "dono: construtora — equipe de pico"),
    ("nucleo.canteiro", "CARGA_MANUAL_KG", "norma", "NR-17 e pratica: carga por pessoa"),
    ("nucleo.canteiro", "MONTADORES_POR_PAINEL", "padrao", "quatro montadores por painel", 4, "pessoas"),
    ("nucleo.canteiro", "CAVALETE_MM_POR_PAINEL", "padrao", "espaco por painel em pe no cavalete", 100, "mm"),
    ("nucleo.canteiro", "PLACAS_POR_PALETE", "hipotese", "dono: fornecedor das placas"),
    ("nucleo.canteiro", "PALETE", "norma", "palete comercial"),
    ("nucleo.canteiro", "CONTEINER_20", "norma", "conteiner ISO de 20 pes"),
    ("nucleo.canteiro", "SANITARIO_QUIMICO", "norma", "cabine comercial"),
    ("nucleo.canteiro", "BAIA", "padrao", "baia de residuos", (2_000, 2_000), "mm"),
    ("nucleo.canteiro", "CLASSES_RESIDUO", "norma", "CONAMA 307"),
    ("nucleo.canteiro", "C_SOLO_EXPOSTO", "hipotese", "dono: hidrologo/obra — escoamento do solo exposto"),
    ("nucleo.canteiro", "PISTA_LARG_MIN", "padrao", "largura minima da pista de veiculos", 3_500, "mm"),
    ("nucleo.canteiro", "NR18", "norma", "NR-18: sanitarios, vestiario, refeitorio, tapume"),
    ("nucleo.canteiro", "VALA", "padrao", "vala provisoria 300 x 300 a 1 %"),
    ("nucleo.canteiro", "CAIXA_SEDIMENTACAO", "padrao", "caixa de sedimentacao 1,0 x 1,0 x 0,8 m"),
    ("nucleo.canteiro", "LIGACAO_PROVISORIA", "hipotese", "dono: concessionarias — padrao e cavalete provisorios"),
    # ---- gas, ar e ruido
    ("nucleo.gas", "ABRAC_H", "padrao", "abracadeira da linha frigorigena na horizontal", 1_500, "mm"),
    ("nucleo.gas", "ABRAC_V", "padrao", "abracadeira da linha frigorigena na vertical", 2_000, "mm"),
    ("nucleo.gas", "ABRIGO", "norma", "NBR 15526: abrigo da central GLP"),
    ("nucleo.gas", "AR_NOVO_LS_M2", "norma", "NBR 16401: ar novo por m2"),
    ("nucleo.gas", "AR_NOVO_LS_PESSOA", "norma", "NBR 16401: ar novo por pessoa"),
    ("nucleo.gas", "FATOR_PERCURSO", "hipotese", "dono: instalador — sinuosidade da rede de gas"),
    ("nucleo.gas", "LIMITE_DECK", "norma", "NBR 10152: area externa de lazer"),
    ("nucleo.gas", "LIMITE_DORMITORIO", "norma", "NBR 10152: dormitorio, conforto"),
    ("nucleo.gas", "LW_BOMBA", "hipotese", "dono: fabricante da bomba de recalque"),
    ("nucleo.gas", "LW_BOMBA_PISCINA", "hipotese", "dono: fabricante da bomba da piscina"),
    ("nucleo.gas", "LW_CONDENSADORA", "hipotese", "dono: fabricante do split (catalogo)"),
    ("nucleo.gas", "PCI_GLP_KWH_KG", "norma", "poder calorifico do GLP"),
    ("nucleo.gas", "POTENCIA_KW", "hipotese", "dono: fabricante do cooktop e da churrasqueira"),
    ("nucleo.gas", "RW_JANELA", "hipotese", "dono: fabricante do vidro laminado"),
    ("nucleo.gas", "TUBO", "norma", "catalogo: tubo de cobre classe A"),
    ("nucleo.gas", "Z_CONDENSADORA", "padrao", "condensadora sobre base no piso do nicho", 600, "mm"),
    # ---- circuitos
    ("nucleo.circuitos", "COR_FASE", "padrao", "cor por fase: A preto, B vermelho, C branco"),
    ("nucleo.circuitos", "DG", "norma", "disjuntor geral"),
    ("nucleo.circuitos", "DISJ", "norma", "correntes nominais comerciais"),
    ("nucleo.circuitos", "DPS", "norma", "NBR 5410 / 5419: DPS"),
    ("nucleo.circuitos", "DR", "norma", "NBR 5410: DR de 30 mA"),
    ("nucleo.circuitos", "ELETRODUTO", "norma", "NBR 5410: ocupacao de 40 % do eletroduto"),
    ("nucleo.circuitos", "FATOR_PERCURSO", "hipotese", "dono: superado pelo percurso real (R80); fica como reserva"),
    ("nucleo.circuitos", "IZ", "norma", "NBR 5410 tabela 36, B1, PVC"),
    ("nucleo.circuitos", "PONTO_ILUM_M2", "padrao", "uma luminaria a cada 6 m2 como piso minimo", 6.0, "m2"),
    ("nucleo.circuitos", "QUEDA_MAX", "norma", "NBR 5410: queda maxima de 4 %"),
    ("nucleo.circuitos", "RESERVA_VIAS", "padrao", "reserva de 20 % de vias em todo quadro", 0.20, ""),
    ("nucleo.circuitos", "RHO", "norma", "resistividade do cobre"),
    # ---- agua
    ("nucleo.agua", "DI", "norma", "catalogo: diametro interno"),
    ("nucleo.agua", "DN_SUB", "norma", "NBR 5626: DN de sub-ramal por peca"),
    ("nucleo.agua", "FATOR_LOCALIZADAS", "hipotese", "dono: hidraulico — perdas localizadas"),
    ("nucleo.agua", "FATOR_PERCURSO", "hipotese", "dono: superado pelo percurso real (R80); fica como reserva"),
    ("nucleo.agua", "NIVEL_MIN_ACIMA_FUNDO", "padrao", "lamina minima util na caixa", 200, "mm"),
    ("nucleo.agua", "PRESSAO_MAX_KPA", "norma", "NBR 5626: pressao maxima"),
    ("nucleo.agua", "PRESSAO_MIN_KPA", "norma", "NBR 5626: pressao minima"),
    ("nucleo.agua", "REGISTRO", "padrao", "registro por posicao: gaveta no ramal, pressao no box"),
    ("nucleo.agua", "Z_BARRILETE_ABAIXO", "padrao", "barrilete abaixo do fundo da caixa", 300, "mm"),
    ("nucleo.agua", "Z_PECA", "padrao", "altura do ponto de agua por peca"),
    # ---- esgoto
    ("nucleo.esgoto", "ALTURA_VENT_ACIMA_COBERTURA", "norma", "NBR 8160: ventilacao acima da cobertura"),
    ("nucleo.esgoto", "CAIMENTO_ADOTADO", "padrao", "2 % tambem no DN100: o dobro da norma, para nao entupir"),
    ("nucleo.esgoto", "CAIMENTO_COLETOR", "norma", "NBR 8160: coletor enterrado"),
    ("nucleo.esgoto", "CAIMENTO_NORMA", "norma", "NBR 8160: caimento minimo"),
    ("nucleo.esgoto", "CAIXA_GORDURA", "norma", "NBR 8160 5.1.4.3"),
    ("nucleo.esgoto", "CAIXA_SIFONADA", "norma", "catalogo"),
    ("nucleo.esgoto", "CI_DIM", "padrao", "caixa de inspecao 600 x 600", (600, 600), "mm"),
    ("nucleo.esgoto", "CI_ESPACAMENTO_MAX", "norma", "NBR 8160: caixa a cada 15 m"),
    ("nucleo.esgoto", "DIST_VENT_MAX", "norma", "NBR 8160: distancia do desconector ao tubo ventilador"),
    ("nucleo.esgoto", "DN_PECA", "norma", "NBR 8160: DN por peca"),
    ("nucleo.esgoto", "DN_POR_UHC", "norma", "NBR 8160: DN por UHC"),
    ("nucleo.esgoto", "DN_VENT_COLUNA", "norma", "NBR 8160"),
    ("nucleo.esgoto", "DN_VENT_RAMAL", "norma", "NBR 8160"),
    ("nucleo.esgoto", "FATOR_PERCURSO", "hipotese", "dono: superado pelo percurso real no que e de parede; fica para o sob-piso"),
    ("nucleo.esgoto", "PROF_SAIDA_CASA", "padrao", "fundo do tubo ao sair da casa", 500, "mm"),
    ("nucleo.esgoto", "RECOBRIMENTO_MIN", "norma", "NBR 8160: recobrimento"),
    # ---- luminotecnica
    ("nucleo.luminotecnica", "ALTURA_PENDENTE", "padrao", "acima disto, pendente em vez de downlight", 4.0, "m"),
    ("nucleo.luminotecnica", "ALVO", "norma", "NBR 8995-1: iluminancia por tarefa"),
    ("nucleo.luminotecnica", "EFICACIA_MIN", "padrao", "so LED de linha: eficacia minima", 80.0, "lm/W"),
    ("nucleo.luminotecnica", "FAMILIA", "padrao", "familias de luminaria por forro"),
    ("nucleo.luminotecnica", "FM", "hipotese", "dono: fabricante e rotina de manutencao — fator de manutencao"),
    ("nucleo.luminotecnica", "FORRO_SEM_EMBUTIR", "padrao", "forros que nao recebem embutido"),
    ("nucleo.luminotecnica", "LARGURA_MIN_MALHA", "padrao", "abaixo disto e nicho: um linear", 1.0, "m"),
    ("nucleo.luminotecnica", "LUMINARIAS", "norma", "catalogo de luminarias"),
    ("nucleo.luminotecnica", "PLANO_PADRAO", "norma", "NBR 8995: plano de trabalho a 0,75 m"),
    ("nucleo.luminotecnica", "PLANO_TRABALHO", "norma", "NBR 8995: plano por tarefa"),
    ("nucleo.luminotecnica", "SHR_MAX", "hipotese", "dono: fabricante — curva fotometrica"),
    ("nucleo.luminotecnica", "TCOR", "padrao", "cor da luz por zona: 2.700 K intimo, 3.000 social, 4.000 cozinha e bancada"),
    # ---- marcenaria
    ("nucleo.marcenaria", "BANCADA_ACABADA", "padrao", "topo do tampo", 900, "mm"),
    ("nucleo.marcenaria", "CABECEIRA_FOLGA", "padrao", "cabeceira passa 300 mm de cada lado da cama", 300, "mm"),
    ("nucleo.marcenaria", "CHAPA", "norma", "chapa comercial 1.850 x 2.750"),
    ("nucleo.marcenaria", "CORREDICAS", "norma", "comprimentos comerciais"),
    ("nucleo.marcenaria", "ESP", "padrao", "MDF de 15 mm em caixa, porta e prateleira", 15, "mm"),
    ("nucleo.marcenaria", "ESP_FUNDO", "padrao", "fundo de 6 mm em canal", 6, "mm"),
    ("nucleo.marcenaria", "ESP_TAMPO", "padrao", "tampo de mesa: duas chapas coladas", 30, "mm"),
    ("nucleo.marcenaria", "FAMILIAS", "padrao", "familias de movel e sua modulacao"),
    ("nucleo.marcenaria", "GAVETA_ALT", "padrao", "frente de gaveta", 200, "mm"),
    ("nucleo.marcenaria", "PECA_UNICA", "padrao", "o que nao modula"),
    ("nucleo.marcenaria", "PORTA_MAX", "padrao", "folha maxima: peso e giro", 600, "mm"),
    ("nucleo.marcenaria", "PUXADOR", "padrao", "perfil gola por zona"),
    ("nucleo.marcenaria", "RECUO_RODAPE", "padrao", "rodape do gabinete recuado", 50, "mm"),
    ("nucleo.marcenaria", "RIPA", "padrao", "ripado: secao e passo"),
    ("nucleo.marcenaria", "RODAPE_GABINETE", "padrao", "sapata mais rodape", 100, "mm"),
    ("nucleo.marcenaria", "SERRA", "hipotese", "dono: marcenaria — corte da esquadrejadeira"),
    ("nucleo.marcenaria", "SISTEMA_32", "norma", "sistema 32 de furacao"),
    ("nucleo.marcenaria", "SOB_ESCADA_ALT", "padrao", "altura do armario sob a escada", 1_200, "mm"),
    ("nucleo.marcenaria", "TAMPO_GRANITO", "padrao", "espessura do tampo de pedra", 30, "mm"),
    # ---- dados e seguranca
    ("nucleo.seguranca", "CABO_MAX", "norma", "Cat.6: 90 m de permanent link"),
    ("nucleo.seguranca", "FATOR_PERCURSO", "hipotese", "dono: instalador — sinuosidade do cabo UTP"),
    ("nucleo.seguranca", "RAIO_WIFI", "hipotese", "dono: fabricante do access point"),
    # ---- LSF
    ("nucleo.detalhes_lsf", "JUNTA_MOV_MAX", "norma", "fabricante da placa cimenticia: junta a cada 6 m"),
    ("nucleo.detalhes_lsf", "PLACA", "norma", "placa cimenticia comercial"),
    ("nucleo.detalhes_lsf", "REFORCO", "padrao", "reforco de OSB por familia de carga suspensa"),
    ("nucleo.peca", "BORDA_FURO_MIN", "norma", "AISI: furo a 25 mm da extremidade"),
    ("nucleo.peca", "DIAM_MAX_ALMA", "norma", "AISI: furo ate meia alma"),
    ("nucleo.peca", "PREFIXO", "padrao", "prefixo de codigo por familia"),
    ("nucleo.peca", "ZONA_FURO", "norma", "AISI: zona util para furos"),
    # ---- acabamento
    ("nucleo.acabamento", "ALTURA_BANCADA", "padrao", "topo do tampo (gemeo de marcenaria.BANCADA_ACABADA)", 900, "mm"),
    ("nucleo.acabamento", "DEMAOS", "padrao", "duas demaos de tinta", 2, ""),
    ("nucleo.acabamento", "DEMAOS_FACHADA", "padrao", "duas demaos na fachada", 2, ""),
    ("nucleo.acabamento", "FRONTAO_H", "padrao", "frontao de bancada", 600, "mm"),
    ("nucleo.acabamento", "FRONTAO_H_FOGO", "padrao", "frontao atras da coccao ate a coifa", 2_400, "mm"),
    ("nucleo.acabamento", "JUNTA_POR_M2", "hipotese", "dono: fornecedor do revestimento"),
    ("nucleo.acabamento", "PERDA_REVESTIMENTO", "hipotese", "dono: obra — perda de corte"),
    ("nucleo.acabamento", "PROF_ARMARIO", "padrao", "profundidade do armario", 600, "mm"),
    ("nucleo.acabamento", "RENDIMENTO_ELASTOMERICO", "hipotese", "dono: fabricante da tinta"),
    ("nucleo.acabamento", "RENDIMENTO_SELADOR", "hipotese", "dono: fabricante da tinta"),
    ("nucleo.acabamento", "RENDIMENTO_TINTA", "hipotese", "dono: fabricante da tinta"),
    # ---- eletrica (entrada)
    ("nucleo.eletrica", "DISJUNTORES", "norma", "correntes comerciais do disjuntor geral"),
    ("nucleo.eletrica", "FASES", "norma", "A, B, C"),
    ("nucleo.eletrica", "LIMITE_DESEQUILIBRIO", "norma", "concessionaria: desequilibrio entre fases"),
    ("nucleo.eletrica", "RAMAL", "norma", "NBR 5410: ramal de entrada"),
    ("nucleo.eletrica", "TENSAO_FF", "norma", "220 V (Amazonas Energia)"),
    ("nucleo.eletrica", "TENSAO_FN", "norma", "127 V (Amazonas Energia)"),
]
