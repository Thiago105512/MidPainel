...
TERREO: list[Amb] = [
    ...
    Amb("T-COZ", "COZINHA",            2_400, 13_200, 3_000, 6_000, molhado=True),
    Amb("T-SOC", "ESTAR / JANTAR",     5_400, 13_200, 4_200, 6_000),
    Amb("T-COR", "CORE / ESCADA",      9_600, 13_200, 2_400, 6_000),
    Amb("T-LAV", "LAVANDERIA",         2_400, 19_200, 3_000, 3_000, molhado=True),
    Amb("T-OFI", "OFICINA",            2_400, 22_200, 3_000, 3_000),
    Amb("T-DML", "DESPENSA / DML",     2_400, 25_200, 3_000, 1_200),
    Amb("T-GOU", "GOURMET",            8_400, 19_200, 4_200, 7_200, molhado=True),
]
...
TERREO_ABERTO: list[Amb] = [
    ...
    Amb("T-PAT", "PATIO DE SERVICO",   5_400, 19_200, 3_000, 7_200, aberto=True),
    Amb("T-DKL", "DECK LATERAL",      12_600, 13_200, 4_200, 6_000, aberto=True),
]
...
SUPERIOR: list[Amb] = [
    ...
    Amb("S-HAL", "HALL",      7_800, 16_200, 2_400, 2_400, pav="S", nivel=NIVEL_SUPERIOR),
...
VAOS = [
    ...
    ("P02",   9_300, 13_200, "H", "T"),   # hall -> estar/jantar
    ("P02",   4_200, 13_200, "H", "T"),   # garagem -> cozinha (servico)
    ("P02",   5_400, 16_200, "V", "T"),   # cozinha -> estar/jantar
    ("P02",   9_600, 16_200, "V", "T"),   # estar -> core/escada
    ("J01",   2_400, 16_200, "V", "T"),   # janela cozinha (oeste)
    ("PV02",  6_900, 19_200, "H", "T"),   # estar -> patio de servico
    ("P02",   9_000, 19_200, "H", "T"),   # estar -> gourmet
    ("P02",   8_400, 21_600, "V", "T"),   # gourmet -> patio de servico
    ("PV01", 10_500, 26_400, "H", "T"),   # gourmet -> deck / piscina
    ("PV01", 12_600, 22_800, "V", "T"),   # gourmet -> deck lateral
    ("P04",   5_400, 20_700, "V", "T"),   # lavanderia -> patio
    ("P04",   5_400, 23_700, "V", "T"),   # oficina -> patio
    ("P04",   5_400, 25_800, "V", "T"),   # dml -> patio
    ("J01",   2_400, 20_700, "V", "T"),   # janela lavanderia
    ("J01",   2_400, 23_700, "V", "T"),   # janela oficina
    # ---- superior
    ("P02",   7_800, 17_400, "V", "S"),   # hall -> suite 02
    ("P02",   7_800, 18_600, "V", "S"),   # hall -> suite 03
    ("P02",  10_200, 17_400, "V", "S"),   # hall -> suite master
    ("J01",   2_400, 16_200, "V", "S"),   # janela suite 02
    ("J01",   2_400, 21_000, "V", "S"),   # janela suite 03
...
# ELEMENTOS EXTERNOS
# =========================================================================
PISCINA = dict(x=8_400, y=27_600, w=4_800, h=2_400,
               prainha_w=1_200, prof_prainha=300, prof_principal=1_150,
               lamina_m2=11.52, volume_m3=10.80)
CASA_MAQUINAS = dict(x=6_600, y=27_600, w=1_500, h=1_200)
DECK = dict(x=7_200, y=26_400, w=7_200, h=4_800)          # envolve a piscina
